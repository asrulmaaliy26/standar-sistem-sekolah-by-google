...
export default function PublicSign({ penandatangans }: { penandatangans: Penandatangan[] }) {
    ...
    return (
        <div className="min-h-screen bg-slate-50 py-8">
            <Head title="Tanda Tangani Sertifikat" />

            <div className="px-4 lg:px-8 max-w-screen-xl mx-auto space-y-6">
                
                <div className="bg-white p-6 rounded-xl shadow-sm border border-border">
                    <h1 className="text-2xl font-bold text-slate-800">Tanda Tangani Dokumen PDF</h1>
                    <p className="text-slate-500 mt-1">Dokumen telah dimuat secara otomatis dari pengajuan.</p>
                </div>
